...
annotated_data_yaml_filename = os.path.join(
    os.getcwd(), "new_annotated_pairs.yaml")
...
def next_image_pair_from_saved():
    ...
    img1 = pil_image_to_cv2(
        sd.get_rgb_image_from_scene_name_and_idx(scene_name_1, image_1_idx))
    img2 = pil_image_to_cv2(
        sd.get_rgb_image_from_scene_name_and_idx(scene_name_2, image_2_idx))
