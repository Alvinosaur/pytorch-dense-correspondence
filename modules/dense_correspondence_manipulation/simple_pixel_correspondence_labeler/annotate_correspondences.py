...
def pil_image_to_cv2(pil_image):
    # open and convert between BGR and RGB
...
def get_cv2_img_pair_from_spartan():
    ...
    img_a, img_b = scale_image(img_a, drawing_scale_config), scale_image(
        img_b, drawing_scale_config)
...
def draw_circle1(event, x, y, flags, param):
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        img1_points_picked.append(
            (x/drawing_scale_config, y/drawing_scale_config))
...
def next_image_pair():
    ...
    img1_points_picked = []
    img2_points_picked = []
    [img1, scene_name_1, image_1_idx], [img2, scene_name_2,
                                        image_2_idx] = get_cv2_img_pair_from_spartan()
