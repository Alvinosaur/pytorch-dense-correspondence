...
def already_ran_change_detection(processed_dir):
    file_to_check_1 = os.path.join(
        processed_dir, "rendered_images", "000000_depth.png")
    file_to_check_2 = os.path.join(
        processed_dir, "image_masks", "000000_mask.png")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str,
                        default='/home/manuelli/code/data_volume/sandbox/drill_scenes/01_drill')
    ...
    parser.add_argument('--current_dir', action='store_true', default=True,
